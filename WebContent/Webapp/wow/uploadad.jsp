    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header page-scroll">
                <a class="navbar-brand page-scroll" href="#">广告发布结果</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="upload.jsp">返回</a>
                    </li>
                    <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">发布广告成功</h2>
                    <h2 class="section-heading"><a href="account.jsp">返回个人主页</a></h2>
                    <h2 class="section-heading"><a href="upload.jsp">继续发布广告</a></h2>
                </div>
            </div>
